    ...
    <div className="bg-zinc-800/40 border border-zinc-700/60 rounded-2xl p-4 space-y-3">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-zinc-300">Spotify Integration</span>
          <span className="px-1.5 py-0.5 text-[10px] font-medium rounded-full bg-zinc-700 text-zinc-400">
            optional
          </span>
        </div>
        <div className="flex items-center gap-2">
      ...
      {!showForm && (
        <p className="text-xs text-zinc-500 leading-relaxed">
          {configured
            ? <>Credentials configured — ID: <span className="font-mono text-zinc-400">{existingClientId.slice(0, 8)}…</span></>
        ...
        <div className="space-y-2.5 pt-1">
          <div>
            ...
            <input
              ...
              className="w-full bg-zinc-900 border border-zinc-700 rounded-lg px-3 py-2 text-sm text-white placeholder-zinc-600 focus:outline-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500/20 transition-all"
            />
          </div>
          <div>
          ...
          <button
            ...
            className="w-full py-2 bg-emerald-600 hover:bg-emerald-500 disabled:bg-zinc-700 disabled:text-zinc-500 text-white text-sm font-semibold rounded-xl transition-colors flex items-center justify-center gap-2"
          >
